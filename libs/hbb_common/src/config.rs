...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.2.18"];
pub const RS_PUB_KEY: &str = "CjEab0mP7qlvS4MfbBWR90Zf8YyE7IYhCbhcsHMJIM0=";
...
#[inline]
pub fn is_technician_mode() -> bool {
    HARD_SETTINGS
        .read()
        .unwrap()
        .get("gt-mode")
        .map_or(false, |x| x == "technician")
}
