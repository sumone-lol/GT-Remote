...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem GamerTech Connect..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, GamerTech Connect v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate GamerTech Connectu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate GamerTech Connectu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno GamerTech Connectu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »GamerTech Connect Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep GamerTech Connect background service", "Ohrani GamerTech Connectovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije GamerTech Connect, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "GamerTech Connect potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "GamerTech Connect potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_rustdesk_password_tip", "Preveri geslo za GamerTech Connect"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite GamerTech Connect, prekinite klic in program zaprite."),
        ("scam_text2", "GamerTech Connect omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno GamerTech Connecta odprto"),
        ...
        ("floating_window_tip", "Pomaga pri GamerTech Connect storitvi v ozadju"),
        ...
        ("About GamerTech Connect", "O GamerTech Connectu"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Prosimo, nadgradite GamerTech Connect odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
