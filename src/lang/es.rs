...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conexión a la red GamerTech Connect en progreso..."),
        ...
        ("install_tip", "Debido al Control de cuentas de usuario, es posible que GamerTech Connect no funcione correctamente como escritorio remoto. Para evitar este problema, haga clic en el botón de abajo para instalar GamerTech Connect a nivel de sistema."),
        ("Click to upgrade", "Clic para actualizar"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar su escritorio desde el exterior, debe otorgar permiso a GamerTech Connect de \"Accesibilidad\"."),
        ("config_screen", "Para controlar su escritorio desde el exterior, debe otorgar permiso a GamerTech Connect de \"Grabación de pantalla\"."),
        ...
        ("android_input_permission_tip1", "Para que un dispositivo remoto controle su dispositivo Android a través del ratón o toque, debe permitir que GamerTech Connect use el servicio de \"Accesibilidad\"."),
        ("android_input_permission_tip2", "Vaya a la página de configuración del sistema que se abrirá a continuación, busque y acceda a [Servicios instalados], active el servicio [GamerTech Connect Input]."),
        ...
        ("Turned off", "Apagado"),
        ("Language", "Idioma"),
        ("Keep GamerTech Connect background service", "Dejar GamerTech Connect como Servicio en 2do plano"),
        ...
        ("Show GamerTech Connect", "Mostrar GamerTech Connect"),
        ("This PC", "Este PC"),
        ("or", "o"),
        ...
        ("config_input", "Para controlar el escritorio remoto con el teclado necesitas dar a GamerTech Connect permisos de \"Monitorización de entrada\"."),
        ("config_microphone", "Para poder hablar de forma remota necesitas darle a GamerTech Connect permisos de \"Grabar Audio\"."),
        ...
        ("verify_rustdesk_password_tip", "Verificar la contraseña de GamerTech Connect"),
        ...
        ("scam_text1", "Si estás al teléfono con alguien a quien NO conoces y en quien NO confías y te ha pedido que uses GamerTech Connect e inicies el servicio, no lo hagas y cuelga inmediatamente."),
        ...
        ("selinux_tip", "SELinux está activado en tu dispositivo, lo que puede hacer que GamerTech Connect no se ejecute correctamente como lado controlado."),
        ...
        ("floating_window_tip", "Ayuda a mantener el servicio de GamerTech Connect de fondo"),
        ...
        ("About GamerTech Connect", "Acerca de GamerTech Connect"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Por favor, actualiza el cliente GamerTech Connect a la versión {} o superior en el lado remoto"),
