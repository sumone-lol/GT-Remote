...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "جاري الاتصال بشبكة GamerTech Connect..."),
        ...
        ("install_tip", "بسبب صلاحيات تحكم حساب المستخدم. GamerTech Connect قد لا يعمل بشكل صحيح في جهة البعيد في بعض الحالات. لتفادي ذلك. الرجاء الضغط على الزر ادناه لتثبيت GamerTech Connect في جهازك."),
        ("Click to upgrade", "اضغط للارتقاء"),
        ("Configure", "تهيئة"),
        ("config_acc", "لتتمكن من التحكم بسطح مكتبك البعيد, تحتاج الى منح GamerTech Connect اذونات \"امكانية الوصول\"."),
        ("config_screen", "لتتمكن من الوصول الى سطح مكتبك البعيد, تحتاج الى منح GamerTech Connect اذونات \"تسجيل الشاشة\"."),
        ...
        ("android_input_permission_tip1", "لكي يتمكن جهاز بعيد من التحكم بجهازك الـ Android عن طريق الفارة أو اللمس، يلزمك السماح لـ GamerTech Connect باستخدام خدمة \"إمكانية الوصول\"."),
        ("android_input_permission_tip2", "يرجى الانتقال إلى صفحة إعدادات النظام التالية، والعثور على [الخدمات المثبتة]، وتشغيل خدمة [GamerTech Connect Input]."),
        ...
        ("Turned off", "مطفئ"),
        ("Language", "اللغة"),
        ("Keep GamerTech Connect background service", "ابق خدمة GamerTech Connect تعمل في الخلفية"),
        ("Ignore Battery Optimizations", "تجاهل تحسينات البطارية"),
        ("android_open_battery_optimizations_tip", "اذا اردت تعطيل هذه الميزة, الرجاء الذهاب الى صفحة اعدادات تطبيق GamerTech Connect, ابحث عن البطارية, الغ تحديد غير مقيد"),
        ...
        ("Show GamerTech Connect", "عرض GamerTech Connect"),
        ("This PC", "هذا الحاسب"),
        ("or", "او"),
        ("Elevate", "ارتقاء"),
        ...
        ("config_input", "لتتمكن من التحكم بسطح المكتب البعيد. يجب من GamerTech Connect اذونات \"مراقبة المدخلات\"."),
        ("config_microphone", "لتتمكن من التحدث. يجب منح GamerTech Connect اذونات \"تسجيل الصوت\"."),
        ...
        ("still_click_uac_tip", "لازال يحتاج المستخدم البعيد للضغط على موافق في نافذة تحكم حساب المستخدم في GamerTech Connect الذي يعمل."),
        ...
        ("verify_rustdesk_password_tip", "تحقق من كلمة مرور GamerTech Connect"),
        ...
        ("enable-bot-tip", "تمكين البوت للتفاعل مع GamerTech Connect"),
        ...
        ("About GamerTech Connect", "حول GamerTech Connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "ترقية عميل GamerTech Connect البعيد إلى {}"),
