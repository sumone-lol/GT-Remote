...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Đang kết nối đến mạng lưới GamerTech Connect..."),
        ...
        ("install_tip", "Do cơ chế UAC, GamerTech Connect có thể không hoạt động ổn định ở phía người dùng từ xa trong một số trường hợp. Để tránh vấn đề này, vui lòng nhấn nút bên dưới để cài đặt GamerTech Connect vào hệ thống."),
        ("Click to upgrade", "Nhấn để nâng cấp"),
        ("Configure", "Cấu hình"),
        ("config_acc", "Để điều khiển từ xa, bạn cần cấp quyền \"Trợ năng\" cho GamerTech Connect."),
        ("config_screen", "Để truy cập từ xa, bạn cần cấp quyền \"Ghi màn hình\" cho GamerTech Connect."),
        ...
        ("android_input_permission_tip2", "Vui lòng tìm [Dịch vụ đã cài đặt] trong cài đặt và bật [GamerTech Connect Input]."),
        ...
        ("Turned off", "Đã tắt"),
        ("Language", "Ngôn ngữ"),
        ("Keep GamerTech Connect background service", "Giữ dịch vụ GamerTech Connect chạy nền"),
        ...
        ("Show GamerTech Connect", "Hiện GamerTech Connect"),
        ...
        ("verify_rustdesk_password_tip", "Xác thực mật khẩu GamerTech Connect"),
        ...
        ("scam_text2", "Chỉ sử dụng GamerTech Connect với những người bạn thực sự tin tưởng."),
        ...
        ("allow-only-conn-window-open-tip", "Chỉ cho phép khi cửa sổ GamerTech Connect mở"),
        ...
        ("floating_window_tip", "Giữ GamerTech Connect trên cùng"),
        ...
        ("About GamerTech Connect", "Về GamerTech Connect"),
