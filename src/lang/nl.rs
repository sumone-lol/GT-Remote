...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "Klaar"),
        ("Established", "Opgezet"),
        ("connecting_status", "Verbinding maken met het GamerTech Connect netwerk..."),
        ...
        ("install_tip", "Door UAC-beperkingen lukt het niet altijd om uw bureaublad op afstand te bedienen. Installeer GamerTech Connect op het systeem om dit probleem te voorkomen."),
        ("Click to upgrade", "Klik voor upgrade"),
        ("Configure", "Configureren"),
        ("config_acc", "Om uw apparaat op afstand te kunnen bedienen, moet u GamerTech Connect toestemming voor Toegankelijkheid geven."),
        ("config_screen", "Om uw apparaat op afstand te kunnen bedienen, moet u GamerTech Connect toestemming voor Schermopname geven."),
        ...
        ("android_input_permission_tip1", "Om ervoor te zorgen dat een extern apparaat uw Android-apparaat kan besturen via muis of aanraking, moet u GamerTech Connect toestaan om de \"Toegankelijkheid\" service te gebruiken."),
        ("android_input_permission_tip2", "Ga naar de volgende pagina met systeeminstellingen, zoek en ga naar [Geïnstalleerde Services], schakel de service [GamerTech Connect Input] in."),
        ...
        ("Language", "Taal"),
        ("Keep GamerTech Connect background service", "GamerTech Connect achtergronddienst behouden"),
        ...
        ("Show GamerTech Connect", "Toon GamerTech Connect"),
        ("This PC", "Deze PC"),
        ("or", "of"),
        ("Elevate", "Verhoog"),
        ...
        ("config_input", "Om een extern apparaat met uw toetsenbord te kunnen bedienen, moet u GamerTech Connect toestemming voor Invoer Vastleggen geven."),
        ("config_microphone", "Om te kunnen chatten moet u GamerTech Connect toestemming voor Microfoon geven."),
        ...
        ("still_click_uac_tip", "De gebruiker op afstand moet altijd bevestigen via het UAC-venster van de werkende GamerTech Connect."),
        ...
        ("verify_rustdesk_password_tip", "Bevestiging wachtwoord GamerTech Connect"),
        ...
        ("scam_text1", "Als u aan de telefoon bent met iemand die u NIET kent EN VERTROUWT en die u heeft gevraagd om GamerTech Connect te gebruiken en de service te starten, ga dan niet verder en hang onmiddellijk op."),
        ...
        ("selinux_tip", "SELinux is ingeschakeld op dit apparaat, waardoor GamerTech Connect mogelijk niet goed functioneert als een gecontroleerde kant."),
        ...
        ("allow-only-conn-window-open-tip", "Alleen verbindingen toestaan als het GamerTech Connect-venster geopend is"),
        ...
        ("floating_window_tip", "Helpt GamerTech Connect op de achtergrond actief te houden"),
        ...
        ("About GamerTech Connect", "Over GamerTech Connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Upgrade de GamerTech Connect client naar versie {} of nieuwer op de externe computer!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Standaard controleert GamerTech Connect het certificaat van de server bij het gebruik van protocollen die TLS gebruiken. Wanneer deze optie is ingeschakeld, laat GamerTech Connect verbindingen toe, zelfs als de verificatiestap mislukt."),
        ("Disable UDP", "UDP uitschakelen"),
        ("disable-udp-tip", "Controleert of alleen TCP moet worden gebruikt. Als deze optie is ingeschakeld, gebruikt GamerTech Connect niet langer UDP 21116, maar TCP 21116."),
