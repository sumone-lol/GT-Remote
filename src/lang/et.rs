...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "GamerTech Connecti võrguga ühendumine..."),
        ...
        ("install_tip", "Kasutajakonto kontrolli (UAC) tõttu ei saa GamerTech Connect mõnel juhul korralikult kaugjuhtimispoolena töötada. Kontrolli vältimiseks palun klõpsa alloleval nupul, et GamerTech Connect oma süsteemi paigaldada."),
        ("Click to upgrade", "Vajuta täiendamiseks"),
        ("Configure", "Seadista"),
        ("config_acc", "Töölaua kaugjuhtimiseks tuleb GamerTech Connectile anda \"juurdepääsetavuse\" õigused."),
        ("config_screen", "Töölaua kaugjuhtimiseks tuleb GamerTech Connectile anda \"ekraanisalvestuse\" õigused."),
        ...
        ("android_input_permission_tip1", "Selleks, et kaugseade saaks sinu Androidi seadet juhtida hiire või puute abil, pead andma GamerTech Connectile \"juurdepääsetavuse\" loa."),
        ("android_input_permission_tip2", "Palun mine järgmisele süsteemiseadete lehele, leia ja sisesta [Paigaldatud teenused], lülita teenus [GamerTech Connect Input] sisse."),
        ...
        ("Language", "Keel"),
        ("Keep GamerTech Connect background service", "Säilita GamerTech Connecti taustateenus"),
        ("Ignore Battery Optimizations", "Ignoreeri akuoptimeerimisi"),
        ("android_open_battery_optimizations_tip", "Kui soovid selle funktsiooni keelata, palun mine järgmisele GamerTech Connecti rakenduse seadete lehele, leia ja sisesta [Aku], eemalda linnuke valikult [Piiramata]"),
        ...
        ("Show GamerTech Connect", "Kuva GamerTech Connect"),
        ("This PC", "See arvuti"),
        ("or", "või"),
        ("Elevate", "Tõsta"),
        ...
        ("config_input", "Kaugtöölaua klaviatuuriga juhtimiseks pead andma GamerTech Connectile \"sisendi jälgimise\" õigused."),
        ("config_microphone", "Kaugelt rääkimiseks pead andma GamerTech Connectile \"heli salvestamise\" õigused."),
        ...
        ("still_click_uac_tip", "Kaugkasutaja peab siiski ise vajutama käitatud GamerTech Connecti kasutajakonto kontrollis (UAC) OK-nuppu."),
        ...
        ("verify_rustdesk_password_tip", "Kinnita GamerTech Connecti parool"),
        ...
        ("scam_text1", "Kui räägid telefoniga kellegagi, keda EI TUNNE ja EI USALDA, kes on palunud sul GamerTech Connecti kasutada ja teenus käivitada, ära jätka ning lõpeta kõne koheselt."),
        ...
        ("selinux_tip", "SELinux on su seadmes lubatud, mis võib GamerTech Connectil takistada juhitud poolel toimimist."),
        ...
        ("allow-only-conn-window-open-tip", "Luba ühendus ainult siis, kui GamerTech Connecti aken on avatud."),
        ...
        ("floating_window_tip", "See aitab säilitada GamerTech Connecti taustateenust."),
        ...
        ("About GamerTech Connect", "GamerTech Connecti teave"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Täiendage GamerTech Connecti klient kaugküljel versioonile {} või uuemale!"),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
