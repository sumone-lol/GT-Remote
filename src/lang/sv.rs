...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Ansluter till GamerTech Connect..."),
        ...
        ("install_tip", "På grund av UAC, kan inte GamerTech Connect fungera ordentligt på klientsidan. För att undvika problem med UAC, tryck på knappen nedan för att installera GamerTech Connect på systemet."),
        ("Click to upgrade", "Klicka för att nedgradera"),
        ("Configure", "Konfigurera"),
        ("config_acc", "För att kontrollera din dator på distans måste du ge GamerTech Connect \"Tillgänglighets\" rättigheter."),
        ("config_screen", "För att kontrollera din dator på distans måste du ge GamerTech Connect \"Skärminspelnings\" rättigheter."),
        ...
        ("android_input_permission_tip2", "Gå till systeminställningarna, hitta [Installed Services], sätt på [GamerTech Connect Input] tjänsten."),
        ...
        ("Turned off", "Avstängd"),
        ("Language", "Språk"),
        ("Keep GamerTech Connect background service", "Behåll GamerTech Connect i bakgrunden"),
        ("Ignore Battery Optimizations", "Ignorera batterioptimering"),
        ("android_open_battery_optimizations_tip", "Om du vill stänga av denna funktion, gå till nästa GamerTech Connect programs inställningar, hitta [Batteri], Checka ur [Obegränsad]"),
        ...
        ("Show GamerTech Connect", "Visa GamerTech Connect"),
        ("This PC", "Denna dator"),
        ("or", "eller"),
        ("Elevate", "Höj upp"),
        ("Zoom cursor", "Zoom"),
