...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do GamerTech Connect..."),
        ...
        ("install_tip", "Devido ao UAC, o GamerTech Connect não funciona corretamente como o lado remoto em alguns casos. Para evitar o UAC, por favor clique no botão abaixo para instalar o GamerTech Connect no sistema."),
        ("Click to upgrade", "Clique para fazer o upgrade"),
        ("Configure", "Configurar"),
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao GamerTech Connect permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao GamerTech Connect permissões de \"Gravar a Tela\"/"),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o GamerTech Connect use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [GamerTech Connect Input]."),
        ...
        ("Language", "Idioma"),
        ("Keep GamerTech Connect background service", "Manter o serviço do GamerTech Connect executando em segundo plano"),
        ...
        ("Show GamerTech Connect", "Exibir GamerTech Connect"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do GamerTech Connect."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do GamerTech Connect."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do GamerTech Connect."),
        ...
        ("verify_rustdesk_password_tip", "Verifique a senha do GamerTech Connect"),
        ...
        ("scam_text1", "Se você estiver ao telefone com alguém que NÃO conhece e em quem NÃO confia e essa pessoa pedir para você usar o GamerTech Connect e iniciar o serviço, NÃO faça isso !! e desligue imediatamente."),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o GamerTech Connect funcione corretamente como dispositivo controlado."),
        ...
        ("allow-only-conn-window-open-tip", "Permitir conexões apenas quando a janela do GamerTech Connect estiver aberta"),
        ...
        ("floating_window_tip", "Ajuda a manter o serviço GamerTech Connect em segundo plano"),
        ...
        ("About GamerTech Connect", "Sobre GamerTech Connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Atualize o cliente GamerTech Connect para a versão {} ou superior no lado remoto."),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o GamerTech Connect verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o GamerTech Connect ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o GamerTech Connect não usará mais UDP 21116, TCP 21116 será usado no lugar."),
