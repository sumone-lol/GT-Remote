...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("android_input_permission_tip1", "GamerTech Connect இந்த Android சாதனத்தை கட்டுப்படுத்த \"அணுகல் சேவைகள்\" அனுமதி தேவை."),
        ("android_input_permission_tip2", "சிஸ்டம் அமைப்புகளில் [நிறுவப்பட்ட சேவைகள்] கண்டுபிடித்து, GamerTech Connect சேவை இயக்கவும்."),
        ...
        ("Language", "மொழி"),
        ("Keep GamerTech Connect background service", "GamerTech Connect பின்புல சேவையை வைத்திரு"),
        ("Ignore Battery Optimizations", "பேட்டரி மேம்படுத்தல்களை புறக்கணி"),
        ("android_open_battery_optimizations_tip", "GamerTech Connect க்கு பேட்டரி மேம்படுத்தல் அணைக்க அமைப்புகளுக்கு செல்லவும்"),
        ...
        ("Show GamerTech Connect", "GamerTech Connect ஐ காட்டு"),
        ("This PC", "இந்த PC"),
        ("or", "அல்லது"),
        ("Elevate", "உயர்த்து"),
        ...
        ("scam_text2", "GamerTech Connect ஊழியர் இவ்வாறு தொடர்பு கொள்ள மாட்டார்கள்"),
        ...
        ("selinux_tip", "SELinux இயக்கப்பட்டது, GamerTech Connect அனுமதி வேண்டும்"),
        ...
        ("enable-2fa-desc", "GamerTech Connect இரு காரணி அங்கீகாரம் ஆதரிக்கிறது"),
        ...
        ("enable-bot-desc", "GamerTech Connect Telegram போட் ஆதரிக்கிறது"),
        ("cancel-2fa-confirm-tip", "2fa_ரத்து_உறுதி_குறிப்பு"),
        ("cancel-bot-confirm-tip", "போட்_ரத்து_உறுதி_குறிப்பு"),
        ("About GamerTech Connect", "GamerTech Connect பற்றி"),
