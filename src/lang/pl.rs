...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "GamerTech Connect może nie działać poprawnie na maszynie zdalnej z przyczyn związanych z UAC. W celu uniknięcia problemów z UAC, kliknij poniższy przycisk by zainstalować GamerTech Connect w swoim systemie."),
        ...
        ("Discovered", "Wykryte"),
        ("install_daemon_tip", "By uruchomić GamerTech Connect przy starcie systemu, musisz zainstalować usługę systemową."),
        ("Remote ID", "Zdalne ID"),
        ("Paste", "Wklej"),
        ...
        ("android_input_permission_tip1", "Aby można było sterować Twoim urządzeniem za pomocą myszy lub dotyku, musisz zezwolić GamerTech Connect na korzystanie z usługi \"Ułatwienia dostępu\"."),
        ("android_input_permission_tip2", "Przejdź do następnej strony ustawień systemowych, znajdź i wejdź w [Zainstalowane usługi], włącz usługę [GamerTech Connect Input]."),
        ...
        ("Language", "Język"),
        ("Keep GamerTech Connect background service", "Zachowaj usługę GamerTech Connect w tle"),
        ("Ignore Battery Optimizations", "Ignoruj optymalizację baterii"),
        ("android_open_battery_optimizations_tip", "Jeśli chcesz wyłączyć tę funkcję, przejdź do następnej strony ustawień aplikacji GamerTech Connect, znajdź i wprowadź [Bateria], odznacz [Bez ograniczeń]"),
        ...
        ("Show GamerTech Connect", "Pokaż GamerTech Connect"),
        ...
        ("config_input", "By kontrolować zdalne urządzenie przy pomocy klawiatury, musisz udzielić aplikacji GamerTech Connect uprawnień do \"Urządzeń Wejściowych\"."),
        ("config_microphone", "Aby umożliwić zdalne rozmowy należy przyznać GamerTech Connect uprawnienia do \"Nagrań audio\"."),
        ...
        ("empty_lan_tip", "Ojej, wygląda na to, że nie odkryliśmy żadnych urządzeń z GamerTech Connect w Twojej sieci."),
        ...
        ("verify_rustdesk_password_tip", "Weryfikuj hasło GamerTech Connect"),
        ...
        ("scam_text1", "Jeżeli rozmawiasz przez telefon z osobą której NIE ZNASZ i NIE UFASZ, która prosi Cię o uruchomienie programu GamerTech Connect - nie rób tego i natychmiast się rozłącz."),
        ...
        ("selinux_tip", "SELinux jest włączony na Twoim urządzeniu, co może przeszkodzić w uruchomieniu GamerTech Connect po stronie kontrolowanej."),
        ...
        ("allow-only-conn-window-open-tip", "Zezwalaj na połączenie tylko wtedy, gdy okno GamerTech Connect jest otwarte"),
        ...
        ("floating_window_tip", "Pozwala zachować usługę GamerTech Connect w tle"),
        ...
        ("About GamerTech Connect", "O programie"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Proszę zaktualizować zdalny klient GamerTech Connect do wersji {} lub nowszej!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Domyślnie GamerTech Connect weryfikuje certyfikat serwera dla protokołów korzystających z TLS.\n Po włączeniu tej opcji, GamerTech Connect pominie etap weryfikacji i będzie kontynuował działanie w przypadku negatywnej weryfikacji."),
        ("Disable UDP", "Wyłącz protokół UDP"),
        ("disable-udp-tip", "Kontroluje, czy używać wyłącznie protokołu TCP.\nPo włączeniu tej opcji, GamerTech Connect nie będzie używać protokołu UDP 21116, zamiast niego będzie używać protokołu TCP 21116."),
