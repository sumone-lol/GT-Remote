...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete GamerTech Connect..."),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), GamerTech Connect potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare GamerTech Connect a livello di sistema."),
        ...
        ("config_screen", "Per controllare il desktop dall'esterno, devi fornire a GamerTech Connect il permesso 'Registrazione schermo'."),
        ...
        ("android_input_permission_tip1", "Affinché un dispositivo remoto possa controllare un dispositivo Android tramite mouse o tocco, devi consentire a GamerTech Connect di usare il servizio 'Accessibilità'."),
        ("android_input_permission_tip2", "Vai nella pagina delle impostazioni di sistema che si aprirà di seguito, trova e accedi a [Servizi installati], attiva il servizio [GamerTech Connect Input]."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep GamerTech Connect background service", "Mantieni il servizio di GamerTech Connect in background"),
        ("Ignore Battery Optimizations", "Ignora le ottimizzazioni della batteria"),
        ("android_open_battery_optimizations_tip", "Se vuoi disabilitare questa funzione, vai nelle impostazioni dell'applicazione GamerTech Connect, apri la sezione 'Batteria' e deseleziona 'Senza restrizioni'."),
        ...
        ("Show GamerTech Connect", "Visualizza GamerTech Connect"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("config_input", "Per controllare il desktop remoto con la tastiera, è necessario concedere le autorizzazioni a GamerTech Connect 'Monitoraggio input'."),
        ("config_microphone", "Per poter chiamare, è necessario concedere l'autorizzazione 'Registra audio' a GamerTech Connect."),
        ...
        ("still_click_uac_tip", "Richiedi ancora che l'utente remoto selezioni 'OK' nella finestra UAC dell'esecuzione di GamerTech Connect."),
        ...
        ("verify_rustdesk_password_tip", "Conferma password GamerTech Connect"),
        ...
        ("Exit", "Esci da GamerTech Connect"),
        ("Open", "Apri GamerTech Connect"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare GamerTech Connect e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di GamerTech Connect come lato controllato."),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra GamerTech Connect è aperta"),
        ...
        ("About GamerTech Connect", "Info su GamerTech Connect"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Aggiorna il client GamerTech Connect remoto alla versione {} o successiva!"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, GamerTech Connect verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, GamerTech Connect salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, GamerTech Connect non userà più UDP 21116, verrà invece usato TCP 21116."),
