...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään GamerTech Connect verkkoon..."),
        ...
        ("install_tip", "Joissain tapauksissa GamerTech Connect ei toimi oikein etäpuolella UAC:n vuoksi. Välttääksesi tämän, napsauta alla olevaa painiketta asentaaksesi GamerTech Connectin järjestelmään."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava GamerTech Connectille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava GamerTech Connectille ”Näytön tallennus” oikeudet."),
        ...
        ("Discovered", "Löydetty"),
        ("install_daemon_tip", "Palvelun automaattista käynnistystä varten GamerTech Connect daemon on asennettava järjestelmään."),
        ("Remote ID", "Etätunnus"),
        ("Paste", "Liitä"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota GamerTech Connectille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli GamerTech Connect ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "GamerTech Connect palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa GamerTech Connectin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "GamerTech Connect palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep GamerTech Connect background service", "Pidä GamerTech Connectin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista GamerTech Connectin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show GamerTech Connect", "Näytä GamerTech Connect"),
        ...
        ("verify_rustdesk_password_tip", "Vahvista GamerTech Connect salasanasi kirjautumista varten"),
        ...
        ("scam_text2", "GamerTech Connect ei koskaan pyydä maksua tai etäkäyttöä ilman lupaasi."),
        ...
        ("About GamerTech Connect", "Tietoa GamerTech Connectistä"),
        ...
        ("upgrade_remote_rustdesk_client_to_{}_tip", "Päivitä etä-GamerTech Connect-asiakasversioon {} yhteensopivuuden takaamiseksi"),
